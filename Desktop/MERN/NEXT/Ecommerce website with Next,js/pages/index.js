...
export default function Home() {
  return (
    <div>
      ...
      <div  >
        <Image src="/home.jpg" alt="Image" width={1500} height={400}/>
      </div>
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      ...
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you like. You like code? Then why not wear it?</p>
    </div>
