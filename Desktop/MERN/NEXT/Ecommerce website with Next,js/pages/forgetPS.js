    ...
    <div>
      <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Forget your password</h2>
          <p className="mt-1 text-center  text-sm text-gray-500">
            <a className='mx-2'>OR</a>
            <Link legacyBehavior={true} href={'/login'}>
              <a className="font-semibold leading-6 font-bold text-pink-600 hover:text-indigo-500">Login</a>
            </Link>
          </p>
        </div>
